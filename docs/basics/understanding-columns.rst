...
- **Setting column types**: You can select multiple rows of the Columns Sheet and typign :kbd:`g$`, for example, to set all of the selected columns' type to ``currency``. 
